...
var EntityFactory = (function () {
    ...
    EntityFactory.prototype.buildGetEntitiesUrl = function (entityType, args) {
        var url = '';
    ...
    EntityFactory.prototype.getEntities = function (entityType, args) {
        var url = this.buildGetEntitiesUrl(entityType, args);
        //return this.http.get(url).then(function (response) {
        //    return { results: response.data, totalRecords: (args && args.includeCount ? response.headers('X-InlineCount') : 0) };
        //});
