...
var DataService = (function () {
    ...
    DataService.prototype.getItems = function (url, args) {
        ...
        return this.http.get(url)
            ...
            var inlineCount = res.headers.get('X-InlineCount');
            if (inlineCount)
    ...
    DataService.prototype.getItemsOData = function (url, args) {
        if (args) {
            var firstIn = true;
            if (args.params) {
                for (var p in args.params) {
...
var ODataArguments = (function (_super) {
    __extends(ODataArguments, _super);
...
var FilterGroup = (function (_super) {
    ...
    function FilterGroup(filterOperator) {
        ...
        _this.filterOperator = filterOperator;
        _this.filters = [];
        return _this;
    }
