...
namespace FreeYouTubeDownloader
{
  public class AboutWindow : Form, ILocalizableForm
  {
    ...
    private LinkLabel hyperLabelSubscribe;
    ...
    public void ApplyCurrentLocalization()
    {
      ...
      this.hyperLabelSubscribe.Text = Strings.SubscribeToFYDPro;
      this.labelAppName.Text = LicenseHelper.GetAppTitle(false);
      if (LicenseHelper.IsGenuine)
      {
        this.hyperLabelSubscribe.Visible = false;
        if (!string.IsNullOrEmpty(LicenseHelper.LicensedTo))
        {
          this.labelLicensedTo.Visible = true;
          this.labelLicensedTo.Text = Strings.RegisteredTo + ":  " + LicenseHelper.LicensedTo;
        }
      }
      else
      {
        this.hyperLabelSubscribe.Visible = true;
      ...
      this.labelCopyright.Text = string.Format("© {0} HOW Inc.", (object) DateTime.Now.Year);
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.hyperLabelSubscribe = new LinkLabel();
      ...
      this.labelLicensedTo.Visible = false;
      this.hyperLabelSubscribe.AutoSize = true;
      this.hyperLabelSubscribe.Location = new Point(105, 116);
      this.hyperLabelSubscribe.Name = "hyperLabelSubscribe";
      this.hyperLabelSubscribe.Size = new Size(144, 17);
      this.hyperLabelSubscribe.TabIndex = 6;
      this.hyperLabelSubscribe.TabStop = true;
      this.hyperLabelSubscribe.Text = "Subscribe to FYD Pro";
      this.hyperLabelSubscribe.LinkClicked += new LinkLabelLinkClickedEventHandler(this.OnSubscribeClicked);
      this.AutoScaleDimensions = new SizeF(8f, 16f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.ClientSize = new Size(338, 202);
      this.Controls.Add((Control) this.hyperLabelSubscribe);
