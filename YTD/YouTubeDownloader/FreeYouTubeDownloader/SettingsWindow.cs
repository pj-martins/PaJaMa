...
namespace FreeYouTubeDownloader
{
  public class SettingsWindow : Form, ILocalizableForm
  {
    ...
    public SettingsWindow()
    {
      ...
      this.checkBoxCheckForUpdates.Checked = Settings.Instance.CheckForUpdates;
      this.checkBoxStartWithWindows.Checked = Settings.Instance.StartWithWindows;
    ...
    private void buttonOk_Click(object sender, EventArgs e)
    {
      ...
      Settings.Instance.CheckForUpdates = this.checkBoxCheckForUpdates.Checked;
    ...
    {
      Settings.Instance.StartWithWindows = ((CheckBox) sender).Checked;
    }
    ...
    public void ApplyCurrentLocalization()
    {
      ...
      this.checkBoxCheckForUpdates.Text = Strings.CheckForNewVersion;
      this.checkBoxStartWithWindows.Text = Strings.StartWithWindows;
    ...
    private void InitializeComponent()
    {
      ...
      this.groupBoxBehavioural.Controls.Add((Control) this.checkBoxStartWithWindows);
      this.groupBoxBehavioural.Controls.Add((Control) this.checkBoxCheckForUpdates);
      ...
      this.checkBoxStartWithWindows.Location = new Point(12, 146);
      this.checkBoxStartWithWindows.Name = "checkBoxStartWithWindows";
      this.checkBoxStartWithWindows.Size = new Size(148, 21);
      this.checkBoxStartWithWindows.TabIndex = 9;
      this.checkBoxStartWithWindows.Text = "Start with Windows";
      this.checkBoxStartWithWindows.UseVisualStyleBackColor = true;
      this.checkBoxStartWithWindows.CheckedChanged += new EventHandler(this.checkBoxStartWithWindows_CheckedChanged);
      this.checkBoxCheckForUpdates.AutoSize = true;
      this.checkBoxCheckForUpdates.Location = new Point(12, 118);
      this.checkBoxCheckForUpdates.Name = "checkBoxCheckForUpdates";
      this.checkBoxCheckForUpdates.Size = new Size(145, 21);
      this.checkBoxCheckForUpdates.TabIndex = 8;
