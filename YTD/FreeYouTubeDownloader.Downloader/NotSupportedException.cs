...
// Type: FreeYouTubeDownloader.Downloader.NotSupportedException
...
{
  public class NotSupportedException : ProviderException
  {
    ...
    public NotSupportedException(string message, string siteUrl)
