...
namespace FreeYouTubeDownloader.Downloader
{
    ...
    {
        public static VideoLink GetVideoLink(this IMediaLink[] links, VideoStreamType streamType, VideoQuality videoQuality)
        {
        ...
        public static VideoLink GetVideoLink(this IMediaLink[] links, VideoQuality videoQuality)
        {
        ...
        public static AudioLink GetAudioLink(this IMediaLink[] links, AudioQuality preferredQuality, IEnumerable<AudioStreamType> preferredStreamTypes)
        {
        ...
        public static AudioLink GetAudioLink(this IMediaLink[] links, AudioQuality preferredQuality)
        {
