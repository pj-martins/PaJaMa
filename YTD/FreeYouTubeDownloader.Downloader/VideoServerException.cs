...
// Type: FreeYouTubeDownloader.Downloader.VideoServerException
...
{
  public class VideoServerException : ProviderException
  {
    public VideoServerException(string message)
      : base(message)
    {
    }

    public VideoServerException(string message, string siteUrl)
